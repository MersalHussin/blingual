    ...
    <section id="courses" className="courses">
      <div className="container">
        ...
        <Link to="/Adults" onClick={scrollToTop} className="course-card">
            ...
            <img src={"./assets/Adults.webp" || "/placeholder.svg"} alt="Teens learning English" />
            </div>
          ...
          <Link to="/Teens" onClick={scrollToTop} className="course-card blue">
            <div className="course-image">
              <img src={"./assets/Teens.webp" || "/placeholder.svg"} alt="Teens learning English" />
            </div>
            <div className="course-info">
              <h3>Teens</h3>
            </div>
          ...
          <Link to="/Kids" onClick={scrollToTop} className="course-card">
            <div className="course-image">
              <img src={"./assets/Kids.webp" || "/placeholder.svg"} alt="Kids learning English" />
            </div>
            <div className="course-info">
              <h3>Kids</h3>
            </div>
